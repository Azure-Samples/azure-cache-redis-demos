...
namespace eShop.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, ICartService cartService)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await TransferAnonymousCartToUserAsync(Input?.Email);
